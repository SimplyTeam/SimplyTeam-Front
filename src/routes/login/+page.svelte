        ...
        <div class="mt-5 flex flex-col items-center">
            ...
            <div class="w-full flex-1 mt-8">
                <div class="flex flex-col items-center">
                    <button
                            class="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800
            ...
            <div class="my-5 border-b text-center">
                <div class="leading-none px-2 inline-block text-sm text-gray-600
            ...
            <div class="flex flex-col w-full">
                <div class="flex flex-col w-full">
                    ...
                    <input class="w-full max-w-xs px-8 py-4 rounded-lg font-medium bg-indigo-100 border border-gray-200
