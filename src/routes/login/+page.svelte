        ...
        <div class="mt-5 flex flex-col items-center">
            ...
            <div class="flex flex-col w-full">
                <div class="flex flex-col items-center">
                    ...
                    <input class="w-full max-w-sm px-8 py-4 rounded-lg font-medium bg-indigo-100 border border-gray-200
                ...
                <div class="flex flex-col items-center">
                    <Button class="w-full max-w-sm mt-5">Se connecter</Button>
