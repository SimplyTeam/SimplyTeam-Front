	...
	const slides: Slide[] = [
		{
			...
			description:
				'Organisez votre travail en sprints pour une concentration maximale sur des périodes définies.',
		...
		},
		{
			...
			description:
				'Gagnez des points à chaque étape accomplie, montez en niveau et recevez des récompenses virtuelles',
		...
		},
		{
			...
			description:
				'Atteignez des jalons spécifiques pour débloquer des codes promo exclusifs sur des produits et services sélectionnés',
	...
	const prices = [
		{
			...
			price: 0,
			description:
				"Conçu pour les petites équipes en quête d'organisation efficace pour divers projets.",
		...
		},
		{
			...
			price: 10,
			description:
				"Conçu pour offrir une solution abordable et puissante aux équipes en quête d'une gestion de tâches optimale.",
	...
	<div class="hero min-h-[60vh]">
		<div class="hero-content flex-col xl:flex-row-reverse">
			<div class="relative h-[20vh] md:h-[40vh] xl:h-[60vh] w-full md:w-1/3 xl:w-2/3">
				<HeroIllustration
					class="absolute z-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[20rem] md:w-[32rem] xl:w-[48rem]"
				/>
			</div>
			<div class="text-white">
				<h1 class="text-3xl md:text-5xl font-bold">
					Gérez vos projets avec plaisir et simplement !
				</h1>
				<p class="py-6">
...
<section class=" rounded-xl w-3/4  mx-auto -translate-y-[15vh] bg-white px-4 py-6">
...
<section class="py-16" id="pricing-section">
	<h2 class="mx-auto my-8 text-center text-2xl font-bold">
		Nos <span class="text-primary">tarifs</span> flexibles pour
		<span class="text-primary">tous</span>
	</h2>
	<PricesTable {prices} />
</section>
