	...
	<div class="flex flex-col w-full">
		...
		>
			<div class:hidden={otherField}>
				...
				<div class="flex flex-col items-center">
					<Button on:click={checkOtherField} class={isFilledNameAndEmail ? 'w-full max-w-sm mt-5' : ' btn-disabled w-full max-w-sm mt-5'}>
						Continuer
					</Button>
			...
			<div class:hidden={!otherField}>
				...
				<div class="flex flex-col">
					<div class="flex justify-center">
						<Button on:click={() => (otherField = !otherField)} class=" w-1/3 btn-accent mr-10 mt-5">retour</Button>
						<Button type="submit" class={isFilled ? 'w-1/3 mt-5' : 'btn-disabled w-1/3 mt-5'}>S'inscrire</Button>
					</div>
