...
<div class="{$$props.class} w-full">
	...
	<div class="relative form-control">
		...
		<input
			...
			class="{$$props.class} w-full px-8 py-4 rounded-lg font-medium border border-gray-200 placeholder-gray-500 text-xs focus:outline-none focus:border-gray-400 focus:bg-white"
			{name}
